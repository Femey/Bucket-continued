...
public class Feature
    ...
    public TextManager renderer = Bucket.textManager;
    private String name;
    ...
    public Setting register(Setting setting) {
        ...
        if (this instanceof Module && Feature.mc.currentScreen instanceof BucketGui) {
            BucketGui.getInstance().updateModule((Module) this);
        }
        return setting;
    }
