...
import me.Bucket.manager.ConfigManager;
...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : Bucket.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module : Bucket.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = Bucket.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = Bucket.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
