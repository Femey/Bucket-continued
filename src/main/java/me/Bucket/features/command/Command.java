package me.Bucket.features.command;
...
public abstract class Command
    ...
    public static void sendMessage(String message, boolean notification) {
        Command.sendSilentMessage(Bucket.commandManager.getClientMessage() + " " + "\u00a7r" + message);
        if (notification) {
            Bucket.notificationManager.addNotification(message, 3000L);
        }
    }
    ...
    public static String getCommandPrefix() {
        return Bucket.commandManager.getPrefix();
    }
