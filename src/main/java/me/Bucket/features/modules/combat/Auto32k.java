...
public class Auto32k
    ...
    public void onKeyInput(InputEvent.KeyInputEvent event) {
        ...
        if (Keyboard.getEventKeyState() && !(Auto32k.mc.currentScreen instanceof BucketGui) && this.switchBind.getValue().getKey() == Keyboard.getEventKey() && this.withBind.getValue().booleanValue()) {
            if (this.switching) {
                this.resetFields();
                this.switching = true;
            }
    ...
    private void processNormal32k() {
        ...
        if (this.placeTimer.passedMs(this.delay.getValue().intValue())) {
            ...
            switch (this.currentStep) {
                ...
                default: {
                    Command.sendMessage("\u00a7cThis shouldnt happen, report to Raptor!!!");
                    Command.sendMessage("\u00a7cThis shouldnt happen, report to Raptor!!!");
                    Command.sendMessage("\u00a7cThis shouldnt happen, report to Raptor!!!");
                    Command.sendMessage("\u00a7cThis shouldnt happen, report to Raptor!!!");
                    Command.sendMessage("\u00a7cThis shouldnt happen, report to Raptor!!!");
