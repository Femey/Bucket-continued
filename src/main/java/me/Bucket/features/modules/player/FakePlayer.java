...
public class FakePlayer
        extends Module {
    private final String name = "Just_a_Raptor";
    ...
    public void onEnable() {
        ...
        if (FakePlayer.mc.player != null) {
            try {
                ...
                this._fakePlayer = new EntityOtherPlayerMP(FakePlayer.mc.world, new GameProfile(UUID.fromString("465a2f5d-d66d-487e-bf14-f3aa81219b0f"), this.name));
