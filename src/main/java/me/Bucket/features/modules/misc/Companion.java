...
public class Companion
    ...
    public Setting<String> deathMessages = this.register(new Setting<String>("DeathMessage", "<player> better luck next time!"));
    ...
    public void onEnable() {
        this.narrator.say("Welcome to Bucket made by WobblyBananaHat");
    }
