...
import me.Bucket.util.NordTessellator;
import me.Bucket.util.TotemPopCham;
...
public class PopChams extends Module {
    ...
    public static final Setting<Integer> bL = new Setting<Integer>("GreenLine", 42, 0, 255);
    ...
    public PopChams() {
        super("PopChams", "Renders when someone pops", Category.RENDER, true, false, false);
        register(self);
        register(rL);
        register(gL);
        register(bL);
