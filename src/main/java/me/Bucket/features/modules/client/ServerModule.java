...
import me.Bucket.mixin.mixins.accessors.IC00Handshake;
...
public class ServerModule
    ...
    public Setting<String> ip = this.register(new Setting<String>("BucketIP", "0.0.0.0.0"));
    public Setting<String> port = this.register(new Setting<String>("Port", "0").setRenderName(true));
    public Setting<String> serverIP = this.register(new Setting<String>("ServerIP", ""));
    ...
    public ServerModule() {
        super("PingBypass", "Manages Buckets`s internal Server", Module.Category.CLIENT, false, false, true);
        instance = this;
    }
