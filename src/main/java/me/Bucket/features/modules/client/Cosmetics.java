...
public class Cosmetics
    ...
    public void onRenderPlayer(RenderPlayerEvent.Post event) {
        if (!Bucket.cosmeticsManager.hasCosmetics(event.getEntityPlayer()) || EntityUtil.isFakePlayer(event.getEntityPlayer())) {
            return;
        }
        for (ModelBase model : Bucket.cosmeticsManager.getRenderModels(event.getEntityPlayer())) {
