...
import me.Bucket.event.events.KeyEvent;
...
public class NoSlowDown
    ...
    public void onUpdate() {
        ...
        if (this.webs.getValue().booleanValue() && Bucket.moduleManager.getModuleByClass(Flight.class).isDisabled() && Bucket.moduleManager.getModuleByClass(Phase.class).isDisabled() && NoSlowDown.mc.player.isInWeb) {
