...
import me.Bucket.features.modules.player.*;
...
import me.Bucket.features.modules.troll.*;
...
public class ModuleManager
    ...
    public void onKeyPressed(int eventKey) {
        if (eventKey == 0 || !Keyboard.getEventKeyState() || ModuleManager.mc.currentScreen instanceof BucketGui) {
            return;
        }
        this.modules.forEach(module -> {
